...
$html=' <h3 align="center" cellspacing="0"><br><br><br>PEMERINTAH KOTA BANDUNG<br>
        ...
        <h4 align="center"><u>SURAT PENGANTAR UNTUK MENDAPATKAN<br>SURAT KETERANGAN KELAKUAN BAIK</u></h4>
        ';
        foreach ($hasil as $h) {
$html.= '
        ...
        <table cellspacing="1" bgcolor="#fff" cellpadding="0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan Surat Keterangan dari  RT '.$h['rt'].' RW '.$h['rw'].' Nomor  '.$h['no_pengantar'].' tanggal '.date_indo($h['tgl_pengantar']).', yang bersangkutan adalah :</p>
            <p align="justify">
            1.	Berkelakuan baik dalam kehidupan masyarakat<br>
            2.	Tidak / pernah tersangkut perkara kriminalitas dengan Instansi Kepolisian<br>
            3.	Tidak dalam status tahanan berwajib<br>
            4.	Tidak / pernah terlibat penggunaan obat-obatan terlarang.
            </p>
