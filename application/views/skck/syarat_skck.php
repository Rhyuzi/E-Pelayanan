            <ul class="ul2">
                <li class="col-sm-3 li2"><a class="aktif" href="<?php echo site_url('skck');?>">Persyaratan</a></li>
            ...
            <div class="isian">
                <p style="font-size: 18px;">Berikut Persyaratan Pembuatan Surat Pengantar SKCK :</p><br><br>
                <?php echo form_open('skck'); ?>
