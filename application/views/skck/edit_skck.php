<ul class="ul2">
    ...
    <li class="col-sm-3 li2"><a href="<?php echo site_url('skck');?>">Isian</a></li>
    <li class="col-sm-3 li2"><a href="<?php echo site_url('skck');?>">Print Preview</a></li>
    <li class="col-sm-3 li2"><a class="aktif" href="<?php echo site_url('skck');?>">Ubah</a></li>
</ul>
<div class="isian">
    <?php echo form_open('skck/edit/'.$data_lama['no_reg']); ?>
        <!--nomor surat-->
        <div class="form-row">
        ...
        <div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="no_kk" name="no_kk" value="<?= $data_lama['kk']; ?>">
