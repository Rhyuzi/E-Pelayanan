            <ul class="ul2">
                <li class="col-sm-3 li2"><a class="aktif" href="<?php echo site_url('kematian');?>">Persyaratan</a></li>
            ...
            <div class="isian">
                <p style="font-size: 18px;">Berikut Persyaratan Pembuatan Surat Kematian :</p><br><br>
                <?php echo form_open('kematian'); ?>
                    ...
                    <input type="checkbox" name="rs"> Fotokopi Keterangan Kematian dari RS / Dokter <br><br>
