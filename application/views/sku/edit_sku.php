            ...
            <div class="isian">
                <?php echo form_open('sku/edit/'.$data_lama['no_reg']); ?>
                    <!--nomor surat-->
                    <div class="form-row">
                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="pekerjaan" class="form-control" id="pekerjaan" value="<?= $data_lama['kerja']; ?>">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="reg_rw" name="reg_rw" value="<?= $data_lama['no_pengantar']; ?>">
                            <?php echo form_error('reg_rw', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Tanggal</label>
                            <input type="date" class="form-control" id="tgl_reg" name="tgl_reg" value="<?= $data_lama['tgl_pengantar']; ?>">
                            <?php echo form_error('reg_rw', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="usaha" class="form-control" id="usaha" value="<?= $data_lama['usaha']; ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control mb-3" id="alamat" name="alamat_usaha" rows="3"><?= $data_lama['alamat_usaha']; ?></textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="untuk" class="form-control" id="untuk" value="<?= $data_lama['untuk']; ?>">
