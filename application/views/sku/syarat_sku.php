<ul class="ul2">
    <li class="col-sm-3 li2"><a class="aktif" href="<?php echo site_url('sku');?>">Persyaratan</a></li>
    <li class="col-sm-3 li2"><a href="<?php echo site_url('sku');?>">Isian</a></li>
...
<div class="isian">
    <p style="font-size: 18px;">Berikut Persyaratan Pembuatan Surat Keterangan Usaha :</p><br><br>
    <?php echo form_open('sku'); ?>
