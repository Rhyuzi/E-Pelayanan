...
<div class="isian">
    <?php echo form_open('rs/form'); ?>
        ...
        <div>
            ...
            <div class="form-group row">
                <label for="kewarganegaraan" class="col-sm-2 col-form-label">ewarganegaraan</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="rs" class="form-control" id="rs" placeholder="Di Rawat di Rumah Sakit">
