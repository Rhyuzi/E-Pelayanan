<ul class="ul2">
    ...
    <li class="col-sm-3 li2"><a class="aktif" href="<?php echo site_url('pbb');?>">Isian</a></li>
    ...
    <?php echo form_open('pbb/form'); ?>
        ...
        <div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="sppt" name="sppt" placeholder="No. Objek Pajak">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="karena" name="karena" placeholder="Penyebab Mengajukan SKTM PBB">
