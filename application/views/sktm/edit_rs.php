<ul class="ul2">
    <li class="col-sm-3 li2"><a href="<?php echo site_url('rs');?>">Persyaratan</a></li>
    ...
    <li class="col-sm-3 li2"><a class="aktif" href="<?php echo site_url('rs');?>">Ubah</a></li>
</ul>
<div class="isian">
    <?php echo form_open('rs/edit/'.$data_lama['no_reg']); ?>
        <!--nomor surat-->
        <div class="form-row">
        ...
        <div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kewarganegaraan" name="kewarganegaraan" value="<?= $data_lama['kewarganegaraan']; ?>">
            ...
            <div class="form-group row">
                <label for="rs" class="col-sm-2 col-form-label">Rumah Sakit</label>
                <div class="col-sm-10">
                    <input type="text" name="rs" class="form-control" id="rs" value="<?= $data_lama['rs']; ?>">
