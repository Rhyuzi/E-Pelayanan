...
$html=' <h3 align="center" cellspacing="0"><br><br><br>PEMERINTAH KOTA BANDUNG<br>
        ...
        foreach ($hasil as $h) {
$html.= '
        <p align="center">Nomor: '.$h['no_reg'].'/SKTM-PBB/'.bulan_aja($h['dibuat_pada']).'/'.tahun_aja($h['dibuat_pada']).'</p>
        ...
        <table cellspacing="1" bgcolor="#fff" cellpadding="0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr bgcolor="#ffffff">
                <td width="30%">No. Objek Pajak</td>
                <td width="5%">:</td>
                <td width="66%">'.$h['no_sppt'].'</td>
            </tr>
        </table>
            <p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan Surat Keterangan dari  RT '.$h['rt'].' RW '.$h['rw'].' 
                Nomor '.$h['reg_rw'].' tanggal '.date_indo($h['tgl_reg']).' dan pengakuannya, bahwa keadaan ekonominya masuk dalam 
                kategori <b>Masyarakat / Keluarga Tidak Mampu</b>, mengajukan permohonan untuk keringanan pembayaran PBB 
                dikarenakan '.$h['karena'].'.
            </p>
            <p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Surat Keterangan dinyatakan tidak berlaku apabila terjadi pelanggaran peraturan Perundang-undangan 
                dan Perda Kota Bandung serta apabila terdapat kekeliruan/kesalahan dalam pembuatannya, pemohon/pemegang bersedia 
                mempertanggungjawabkan secara hukum tanpa melibatkan pihak manapun.</p>
